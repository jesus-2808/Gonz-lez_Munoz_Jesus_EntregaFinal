...
<body>
  ...
  <div class="page-heading  clearfix asset-bg none">
    ...
    <div id="breadcrumbs">
      ...
      <a title="registro" href="noValidadosView.php" class="home">Solicita tu registro</a>
    </div>
    ...
    <table class="styled-table col-xs-11 ml-2" border="1">
      ...
      <tbody>
        ...
        for ($i = 0; $i < count($datos); $i++) {
          echo "<tr><td>" . $datos[$i]["id_usuario"] . "</td><td>" . $datos[$i]["titulo"] . "</td><td>" . $datos[$i]["id_aula"] . "</td><td>" . $datos[$i]["fecha_creacion"] . "</td>
